...
def plot_excel_data(file_path):
    ...
    plt.xlabel('Proportion of a type of bacteria in the intestinal flora')
    plt.ylabel('Patient Carriage Rate of Specific Bacteria')
...
excel_file_path = input("Please enter the path to the Excel file that needs to be analyzed (Or enter AM to display the MAT number):")
plot_excel_data(excel_file_path)
